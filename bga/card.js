...
const WILD_BOAR_FEMALE = "Wild Boar (Female)";
...
const CARDS_DATA = {
  ...
  222: $f([H_CARD, [WILD_BOAR_FEMALE, BEEHIVE], [BIRCH, SYCAMORE], EDGE_DECK]),
  223: $f([H_CARD, [EUROPEAN_BISON, WILD_BOAR_FEMALE], [OAK, SYCAMORE], EDGE_DECK]),
  224: $f([H_CARD, [WILD_BOAR_FEMALE, EUROPEAN_WILDCAT], [SILVER_FIR, HORSE_CHESTNUT], EDGE_DECK]),
